...
function InfoPage({ moveToParticularInfo, homeBtnLogic }) {
    ...
    return (
        ...
        <div>
            ...
            <div id='sergi' onClick={moveToParticularInfo} className={isLeftToRight() ? 'sergiTitle addTitleFont info-page-titles' : 'sergiTitle addTitleFont info-page-titles'}>
                <h1>{whichFileToUse().sergi}</h1>
                <img src={rightHand} alt='hand' />
            </div>
            <div id='ella' onClick={moveToParticularInfo} className='ellaTitle addTitleFont info-page-titles'>
            ...
            <div id='og' onClick={moveToParticularInfo} className='ogTitle addTitleFont info-page-titles'>
                <h1>{whichFileToUse().og}</h1>
                <img src={downHand} alt='hand' />
            </div>
            <div id='water' onClick={moveToParticularInfo} className='waterTitle addTitleFont info-page-titles'>
